...
def telegram_send():
    ...
    # Extract only the branch name from GITHUB_REF, default to 'cnb'
    branch = os.environ.get("GITHUB_REF", "refs/heads/cnb").split("/")[-1]
...
\U0001f517 \u2022 <b>SHA256:</b> <code>{sha256}</code>
    ...
    inline_keyboard = [
        ...
        [
            ...
            {"text": "\U0001F977 ReSukiSU-SUSFS \U0001F977", "url": f"{base_url}/ReSukiSU-SUSFS.img"}
        ],
        [
